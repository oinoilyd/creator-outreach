...
export const ALL_OUTREACH_COLS: OutreachColDef[] = [
  ...
  { id: 'followUpDate',    label: 'Follow Up Date',    defaultVisible: false, defaultWidth: 140, tooltip: 'When to ping them again. Past dates with status Open show up under Stale follow-ups in Analytics.' },
