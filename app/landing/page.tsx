    ...
    >
      ...
      <footer className="bg-white dark:bg-[#131826] border-t border-[#0F1733]/10 dark:border-white/10 px-6 py-14">
        <div className="max-w-[1280px] mx-auto grid md:grid-cols-6 gap-8">
          ...
          <FooterCol heading="Legal"     links={[['Privacy','/privacy'],['Terms','/terms'],['Refunds','/refunds'],['Security','/security'],['Subprocessors','/subprocessors'],['Support','/support'],['Cookies','/cookies']]} />
        </div>
      </footer>
    </main>
  )
