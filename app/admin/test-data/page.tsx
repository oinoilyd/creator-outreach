      ...
      <div className="max-w-7xl mx-auto">
        ...
        {totalAll === 0 ? (
          <div className="rounded-xl border border-border bg-card/40 px-6 py-12 text-center">
            ...
            <div className="text-sm font-semibold text-foreground/90 mb-1">No test data found</div>
        ...
        <div className="mt-8 rounded-xl border border-border/60 bg-card/20 p-4 text-[12px] text-muted-foreground leading-relaxed">
          <p>
            <span className="text-foreground font-semibold">Why these exist:</span>{' '}
...
function Row({ r }: { r: EnrichmentLatest }) {
  ...
  return (
    <tr className="border-b border-border/60 hover:bg-card/40 transition-colors">
      ...
      <td className="px-4 py-3">
        <div className="text-[11px] text-foreground/90 font-mono break-all" title={r.yt_channel_id}>
          {r.yt_channel_id}
        </div>
      </td>
      <td className="px-4 py-3 text-foreground">
        {r.channel_name || <span className="text-muted-foreground/60 italic">unnamed</span>}
...
function StatBox({
  ...
  return (
    <div className="rounded-lg border border-border bg-card/40 px-4 py-3">
      <div className="text-[10px] uppercase tracking-[0.18em] text-muted-foreground/80 font-bold mb-1 truncate" title={label}>
        {label}
      </div>
